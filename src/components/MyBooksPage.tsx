        ...
        {userBooks.length === 0 ? (
          <Card className="p-12 border-2 border-dashed border-gray-300 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Comienza a explorar nuestra colección y pide
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {userBooks.map((book) => (
              <Card
                key={book.id}
                className="p-6 border-2 border-gray-300"
              >
          ...
          <Card className="mt-8 p-6 border-2 border-gray-300 bg-blue-50">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">
                  Recuerda devolver los libros cuando termines
                  de leerlos
                </p>
              </div>
